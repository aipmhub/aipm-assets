...
<img height="120" src="https://registry.npmmirror.com/@aipmorg/assets-logo /latest/files/assets/logo-3d.webp">
...
| NAME                             | NPM                                                                                           | UNPKG                                                  |
| -------------------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| @aipmorg/assets-logo             | \[!\[]\[assets-logo-release]]\[assets-logo-release-url]                                       | \[ALIYUN-UNPKG]\[assets-logo-unpkg]                    |
| @aipmorg/assets-favicons         | [![][assets-favicons-release]][assets-favicons-release-url]                                   | [ALIYUN-UNPKG][assets-favicons-unpkg]                  |
...
| <img src="https://registry.npmmirror.com/@aipmorg/assets-logo /latest/files/assets/logo-3d.webp" width="64" > | <img src="https://registry.npmmirror.com/@aipmorg/assets-logo /latest/files/assets/logo-flat.svg" width="64" > | <img src="https://registry.npmmirror.com/@aipmorg/assets-logo /latest/files/assets/logo-high-contrast.svg" width="64" > | <img src="https://registry.npmmirror.com/@aipmorg/assets-logo /latest/files/assets/logo-text.svg" width="64" > |
| ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
...
![](https://github.com/aipmhub/aipm-assets/blob/master/docs/preview.png?raw=true)
...
```
<link rel="apple-touch-icon" sizes="180x180" href="https://registry.npmmirror.com/@aipmorg/assets-favicons/latest/files/assets/apple-touch-icon.png" />
<link rel="icon" type="image/png" sizes="32x32" href="https://registry.npmmirror.com/@aipmorg/assets-favicons/latest/files/assets/favicon-32x32.png" />
<link rel="icon" type="image/png" sizes="16x16" href="https://registry.npmmirror.com/@aipmorg/assets-favicons/latest/files/assets/favicon-16x16.png" />
<link rel="manifest" href="https://registry.npmmirror.com/@aipmorg/assets-favicons/latest/files/assets/site.webmanifest" />
<link rel="mask-icon" href="https://registry.npmmirror.com/@aipmorg/assets-favicons/latest/files/assets/safari-pinned-tab.svg" color="#000000" />
<meta name="apple-mobile-web-app-title" content="AiPMHub" />
<meta name="application-name" content="AiPMHub" />
...
```bash
$ git clone https://github.com/aipmhub/aipm-assets.git
$ cd lobe-assets
$ bun install
```
...
\[assets-logo-release]: <https://img.shields.io/npm/v/@aipmorg/assets-logo> ?color=369eff\&labelColor=black\&logo=npm\&logoColor=white\&style=flat-square
\[assets-logo-release-url]: <https://www.npmjs.com/package/@aipmorg/assets-logo>
\[assets-logo-unpkg]: <https://registry.npmmirror.com/@aipmorg/assets-logo>
...
\[emojilib-unpkg]: <https://raw.githubusercontent.com/aipmhub/aipm-assets/master/packages/emojilib/index.json>
\[github-action-release-link]: <https://github.com/aipmhub/aipm-assets/actions/workflows/release.yml>
\[github-action-release-shield]: <https://img.shields.io/github/actions/workflow/status/aipmhub/aipm-assets/release.yml?label=release&labelColor=black&logo=githubactions&logoColor=white&style=flat-square>
\[github-codespace-link]: <https://codespaces.new/lobehub/lobe-chat>
\[github-codespace-shield]: <https://github.com/codespaces/badge.svg>
\[github-contrib-link]: <https://github.com/aipmhub/aipm-assets/graphs/contributors>
\[github-contrib-shield]: <https://contrib.rocks/image?repo=lobehub%2Flobe-assets>
\[github-contributors-link]: <https://github.com/aipmhub/aipm-assets/graphs/contributors>
\[github-contributors-shield]: <https://img.shields.io/github/contributors/aipmhub/aipm-assets?color=c4f042&labelColor=black&style=flat-square>
\[github-forks-link]: <https://github.com/aipmhub/aipm-assets/network/members>
\[github-forks-shield]: <https://img.shields.io/github/forks/aipmhub/aipm-assets?color=8ae8ff&labelColor=black&style=flat-square>
\[github-issues-link]: <https://github.com/aipmhub/aipm-assets/issues>
\[github-issues-shield]: <https://img.shields.io/github/issues/aipmhub/aipm-assets?color=ff80eb&labelColor=black&style=flat-square>
\[github-license-link]: <https://github.com/aipmhub/aipm-assets/blob/master/LICENSE>
\[github-license-shield]: <https://img.shields.io/github/license/aipmhub/aipm-assets?color=white&labelColor=black&style=flat-square>
\[github-release-link]: <https://github.com/aipmhub/aipm-assets/releases>
\[github-release-shield]: <https://img.shields.io/github/v/release/aipmhub/aipm-assets?color=369eff&labelColor=black&logo=github&style=flat-square>
\[github-releasedate-link]: <https://github.com/aipmhub/aipm-assets/releases>
\[github-releasedate-shield]: <https://img.shields.io/github/release-date/aipmhub/aipm-assets?labelColor=black&style=flat-square>
\[github-stars-link]: <https://github.com/aipmhub/aipm-assets/network/stargazers>
\[github-stars-shield]: <https://img.shields.io/github/stars/aipmhub/aipm-assets?color=ffcb47&labelColor=black&style=flat-square>
\[logo-3d]: <https://https://registry.npmmirror.com/@aipmorg/assets-logo> /latest/files//assets/logo-3d.webp
\[logo-flat]: <https://https://registry.npmmirror.com/@aipmorg/assets-logo> /latestfiles//assets/logo-flat.svg
\[logo-high-contrast]: <https://https://registry.npmmirror.com/@aipmorg/assets-logo> /latest/files//assets/logo-high-contrast.svg
\[logo-text]: <https://https://registry.npmmirror.com/@aipmorg/assets-logo> /latest/files/assets/logo-text.svg
\[pr-welcome-link]: <https://github.com/aipmhub/aipm-assets/pulls>
...
[assets-favicons-release]: https://img.shields.io/npm/v/@aipmorg/assets-favicons?color=369eff&labelColor=black&logo=npm&logoColor=white&style=flat-square
[assets-favicons-release-url]: https://www.npmjs.com/package/@aipmorg/assets-favicons
[assets-favicons-unpkg]: https://registry.npmmirror.com/@aipmorg/assets-favicons
